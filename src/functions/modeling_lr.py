...
def train_model(X, y):
    ...
    plt.savefig('../results/plots/modeling/confusion_matrix_lr.png')
    plt.close()
    ...
    plt.savefig('../results/plots/modeling/roc_curve_lr.png')
    plt.close()

    return model

def save_model(model, encoder, file_path='../models/lr_model.pkl'):
    import joblib
